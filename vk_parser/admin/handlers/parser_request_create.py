...
from aiohttp.web_exceptions import HTTPInternalServerError, HTTPRequestTimeout
...
from vk_parser.generals.models.parser_request import ParsePostsVkForm, SimpleVkForm
...
class ParserRequestCreateHandler(View, DependenciesMixin, CreateMixin):
    ...
    async def post(self) -> Response:
        try:
            ...
            raise HTTPRequestTimeout(reason="Request processing timed out") from exc
